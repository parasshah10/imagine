    ...
    <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#ededed] px-10 py-3">
      <div className="flex items-center gap-8">
        ...
        <div className="flex items-center gap-9">
          ...
          <Link href="/explore" className="text-[#141414] text-sm font-medium leading-normal">Explore</Link>
          <Link href="/generate" className="text-[#141414] text-sm font-medium leading-normal">Create</Link>
        </div>
      </div>
